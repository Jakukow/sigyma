...
import { useEditExercise } from "@/features/accounts/api/exercises/use-edit-exercise";
...
export const EditExerciseModal = () => {
  const mutation = useEditExercise();
  const { isOpen, onClose, type, data } = useModal();
  const isModalOpen = isOpen && type === "editExercise";
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      type: data.unit as ExerciseType,
    },
  });
